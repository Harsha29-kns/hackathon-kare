                                ...
                                <div key={team._id} className={`relative flex flex-col p-6 rounded-xl border-2 backdrop-blur-sm transition-all duration-300 hover:scale-105 ${styles.container} ${styles.order}`}>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="flex justify-center gap-4 mt-4 pt-4 border-t border-white/10 w-full">
                                            <div><p className="text-xs text-gray-400">Captain's Decision</p><p className="font-semibold text-lg text-white">{team.memoryGameScore}</p></div>
                                            <div><p className="text-xs text-gray-400">Black Pearl Cipher</p><p className="font-semibold text-lg text-white">{team.numberPuzzleScore}</p></div>
                                            <div><p className="text-xs text-gray-400">Lost Compass</p><p className="font-semibold text-lg text-white">{team.stopTheBarScore}</p></div>
                ...
                {theRest.length > 0 && (
                    <div className="space-y-2">
                        <div className="grid grid-cols-12 items-center gap-4 px-4 text-xs font-bold text-gray-400 uppercase">
                            ...
                            <p className="col-span-1 text-center">Captain's Decision</p>
                            <p className="col-span-1 text-center">Black Pearl Cipher</p>
                            <p className="col-span-1 text-center">Lost Compass</p>
